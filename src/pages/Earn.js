...
const Earn = () => {
    ...
    return (<div className="py-4">
      ...
      <div className="space-y-4">
        {tasks.map((task, index) => (<framer_motion_1.motion.div key={task.title} className="card p-4" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1 }}>
            ...
            <framer_motion_1.motion.button className="task-btn w-full" onClick={() => handleTaskComplete(task)} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
